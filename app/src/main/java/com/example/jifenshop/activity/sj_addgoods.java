...
public class sj_addgoods extends AppCompatActivity {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (bean.getStatus() == 1) {
                ...
                Toast.makeText(sj_addgoods.this, "添加成功", Toast.LENGTH_LONG).show();
                intent.setClass(sj_addgoods.this, sj_mygoods.class);
                startActivity(intent);
                finish();
            } else {
                Toast.makeText(sj_addgoods.this, "添加失败", Toast.LENGTH_LONG).show();
            }
        }
    };
    @Override
